...
\begin{gather*}
    ...
    d: \textbf{normally } obl(<s,A>) \textbf{ if } F \\
...
\begin{gather*}
    ...
    lp(\neg obl(<s, A>)) =
        \neg obl((s, A)). \\
    lp(obl(<s, A>) \textbf{ if } cond) =
        obl((s,A)) \leftarrow
            lp(cond) \\
    lp(\neg obl(<s, A>) \textbf{ if } cond) =
        \neg obl((s,A)) \leftarrow
            lp(cond) \\
    lp(d: \textbf{normally } obl(<s, A>) \textbf{ if } cond) =
        obl((s,A)) \leftarrow
            lp(cond),
            \textbf{not } ab(d),
            \textbf{not } \neg obl((s, A)). \\
...
\begin{definition}
    ...
    Likewise, $P_o$ is an obligation policy \textit{induced} by $P$.
\end{definition}
