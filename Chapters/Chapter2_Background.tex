...
Transition systems (also called \textit{transition diagrams} \cite{blount_architecture_2013}) can be thought of analogous to a directed graph that models a discrete dynamic domain.
...
\begin{itemize}
    ...
    \item Each domain-relevant property is represented by a function.
        ...
        These properties are known as \textit{state}.
\end{itemize}
...
Where $obs(F,\ V,\ I)$ denotes that the fluent $F$ was observed to have value $V$ at timestep $I$ and $hpd(A,\ I)$ that action $A$ happened at time step $I$.
