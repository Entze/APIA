...
Among other requirements, the GDPR stipulates that consent must be gathered before any data can be used and that all the actions of automated processes using on the data must be explainable to a third-party.
