...
\begin{gather}
    ...
    \textbf{impossible } assume\_command(c_1, m_1) \textbf{ if } commands(c_1, m_1) \label{eq:apl_action_description}
\end{gather}
...
The static laws from the action description in \cref{eq:apl_action_description} can be encoded as follows:
