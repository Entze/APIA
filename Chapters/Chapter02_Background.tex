...
\begin{gather}
    ...
    lp(P)=\{lp(statement) | statement \in P\} \label{eq:apl_lp_02} \\
...
If S is a set of atoms, then $lp(S)=\{lp(atom) | atom \in S\}$
...
\begin{gather}
    ...
    lp(P,I)=\{lp(statement,I) | statement \in P\} \label{eq:apl_lp_inc_02} \\
