...
\footnotetext{
    \citet{gelfond_authorization_2008} use a different notation than what was introduced in \cref{subsubsec:domain_history} while describing the work of \citet{blount_towards_2014}.
    However, since \citet{gelfond_authorization_2008} do not explicitly provide the logic translation for an agent's history, the approach of \citet{balduccini_aaa_2008,blount_towards_2014} is used below.
}
