...
\lstinputlisting[language=Prolog]{Figures/AOPL_Language/01_Example/Instantiate_Variables.lp}

Suppose we have the following state $s_0$:
\lstinputlisting[language=Prolog]{Figures/AOPL_Language/01_Example/s0.lp}
