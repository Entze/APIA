...
\begin{definition}
    ...
    \begin{itemize}
        ...
        \item An event $<s, A>$ is \textit{non-compliant} with $P$ if $<s, A>$ is neither strongly compliant nor weakly compliant with $P$.
    \end{itemize}
\end{definition}
...
% \lstinputlisting{Figures/AOPL_Language/01_Full_Knowledge/strongly_compliant.clingo.txt}
% \lstinputlisting{Figures/AOPL_Language/01_Full_Knowledge/weakly_or_non_compliant.clingo.txt}
