...
\noindent
where $M$ is a unique identifier for the activity, $C_1, C_2, \dots, C_L$ are the \nth{1}, \nth{2}, \dots, L\textsuperscript{th} \textif{component} of the activity, and $G$ is the goal that $C_1,C_2,\dots,C_L$ achieves.
...
Assuming that $d_34$ is unlocked, the scenario will finish like in Scenario 1.
...
In addition to introducing language $\mathcal{APL}$, \citet{gelfond_authorization_2008} introduce language $\mathcal{AOPL}$ to consider \textit{obligation policies} in addition to authorization policies.
