...
Before the AIA control loop begins, Alice observes that she is in Room 1, Bob is in room 4, the door d34 is unlocked, and that she has not yet greeted Bob.
...
Before the $\mathcal{AIA}$ control loop begins, Alice observes that Bob is not busy working.
In the $(paranoid, subordinate)$ mode
